    ...
    <section style={{ paddingTop: "2rem" }} className="container mx-auto px-4">
      <div className="">
        <div className="h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-md  w-full  bg-slate-200 p-4 rounded-lg shadow-2xl">
            <div>
            ...
            <div className="mt-5">
              {/* <Link className="text-blue-700 hover:text-blue-900" to={'/sign-up'}>create a new account ? </Link> */}
            </div>
